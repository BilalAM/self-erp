...
public class ComponentUtils {
        ...
        /**
         * Creates a transition effect to the specified component (Node)
         * along with the duration of effect and whether it is a fade-in or fade-out
         * effect.
         *
         * @param nodeToApplyTransition : The component to which this effect will be applied to .
         * @param duration              : The duration IN SECONDS of the effect.
         * @param isFadeIn              : Do you want a appear-then-poshhh! effect or a posshh!!-then-appear effect ?
